...
setup(
  name = 'arequesthelper',         # How you named your package folder (MyLib)
  packages = ['arequesthelper'],   # Chose the same as "name"
  ...
  url = "https://github.com/Harukvitalii/modules/tree/main/arequests_helper",   # Provide either the link to your github or to your website
